...
import org.thingsboard.server.dao.hs.entity.po.DictDeviceStandardProperty;
...
@Table(name = HsModelConstants.DICT_DEVICE_STANDARD_PROPERTY_TABLE_NAME)
@EntityListeners(AuditingEntityListener.class)
public class DictDeviceStandardPropertyEntity extends BasePgEntity<DictDeviceStandardPropertyEntity> implements ToData<DictDeviceStandardProperty> {
     ...
     * 名称
     */
    @Column(name = HsModelConstants.DICT_DEVICE_STANDARD_PROPERTY_NAME)
    private String name;

    /**
     * 内容
     */
    @Column(name = HsModelConstants.DICT_DEVICE_STANDARD_PROPERTY_CONTENT)
    private String content;

    /**
     * 标题
     */
    @Column(name = HsModelConstants.DICT_DEVICE_STANDARD_PROPERTY_TITLE)
    ...
    public DictDeviceStandardPropertyEntity() {
    }

    public DictDeviceStandardPropertyEntity(DictDeviceStandardProperty common) {
     ...
     * to data
     */
    public DictDeviceStandardProperty toData() {
        DictDeviceStandardProperty common = new DictDeviceStandardProperty();
