...
public abstract class AbstractWebTest {
    ...
    protected static final String SYS_ADMIN_EMAIL = "sysadmin@huansi.net";
    private static final String SYS_ADMIN_PASSWORD = "sysadmin";

    protected static final String TENANT_ADMIN_EMAIL = "testtenant@huansi.net";
    private static final String TENANT_ADMIN_PASSWORD = "tenant";

    protected static final String CUSTOMER_USER_EMAIL = "testcustomer@huansi.net";
    ...
    protected void loginDifferentTenant() throws Exception {
        ...
        differentTenantAdmin.setEmail("different_tenant@huansi.net");
