...
CREATE TABLE IF NOT EXISTS "tb_user" (
  ...
  "user_creator" varchar(255) COLLATE "pg_catalog"."default",
  "user_name" varchar(255) COLLATE "pg_catalog"."default",
  "phone_number" varchar(255) COLLATE "pg_catalog"."default",
  "active_status" varchar(255) COLLATE "pg_catalog"."default",
  "type" varchar(255) COLLATE "pg_catalog"."default",
  "factory_id" uuid,
...
CREATE TABLE tenant (
  ...
  "county_level" varchar(255) COLLATE "pg_catalog"."default",
