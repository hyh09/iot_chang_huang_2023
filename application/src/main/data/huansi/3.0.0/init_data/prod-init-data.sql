...
--查询工厂
select * from tenant where title like '%上海%';
select * from hs_factory where name like '%上海%';
select * from hs_factory where name like '%新乡%';

--上海：单进单出冷转移印刷机-低给液机-卫星式转移印花机-蒸化机-水洗烘干机
update device set sort = 1
where factory_id = '9d189420-5967-11ec-a244-e3e154b05454'
and name='单进单出冷转移印刷机';
