...
@Component({
  selector: 'tb-chart-settings-filters',
  templateUrl: './chart-settings-filters.component.html'
})
export class ChartSettingsFiltersComponent extends EntityTableHeaderComponent<DeviceDictionary> {
